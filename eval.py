...
def test15():  # Test for List operations
    ...
    e15 = cons(e11, matrix)
    assert(eval_ast(e15, None, name_space) == [
           [-1, 1, 2, 3], [1, 2, 3], ["4", "5", "6"], [True, True, False]])
    e16 = cons(e11, e9)
    assert(eval_ast(e16, None, name_space) == [
           [-1, 1, 2, 3], ["4", "5", "6"], [True, True, False]])
...
def test16():
    ...
    e = Function(
         fn, [i,j], binary_operation("+", i, j), program
    )
    assert eval_ast(e,None, name_space) == (15+2)+(12+3)
